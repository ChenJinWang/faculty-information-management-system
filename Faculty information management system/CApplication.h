...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xce9, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CSVKeepLargeNumbersAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xce9, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	BOOL get_CSVKeepDigitsWithEAsText()
	{
		BOOL result;
		InvokeHelper(0xcea, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CSVKeepDigitsWithEAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xcea, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	BOOL get_CSVDisplayNumberConversionWarning()
	{
		BOOL result;
		InvokeHelper(0xceb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CSVDisplayNumberConversionWarning(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xceb, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
